...
*/
  ...
  TFile * file = new TFile("Wtemplate.root");
  ...
  std::ofstream textFile("smv2.txt");
  ...
  textFile << "-----------------" << std::endl;
  textFile << "shapes * *  Wtemplate.root  $PROCESS    $PROCESS_$SYSTEMATIC " << std::endl;
  textFile << "-----------------" << std::endl;
  textFile << "bin                   stau    stau" << std::endl;
  textFile << "process              wj  rest_bkg" << std::endl;
  ...
  textFile << "CMS_eff_t       lnN      1.04   1.04"<< std::endl;
//  textFile << "CMS_met         lnN      1.04   1.04    1.04"<< std::endl;
  textFile << std::endl;
