...
void PlotLimit_LSP10_BDTmutau_stau100_LSP1My_15_15_comb_35(TString fileList = "list_stau-stau_left_LSP10_BDTmutau_stau100_LSP1My_15_15_comb_35invfb",
...
//  fileName = argv[1];
  ...
  TLatex * lsp = new TLatex(0.20,0.70,legLSP);
  lsp->SetNDC();
