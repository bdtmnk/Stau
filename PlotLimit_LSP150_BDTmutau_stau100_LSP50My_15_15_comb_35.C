...
void PlotLimit_LSP150_BDTmutau_stau100_LSP50My_15_15_comb_35(TString fileList = "list_stau-stau_left_LSP150_BDTmutau_stau100_LSP50My_15_15_comb_35invfb",

	       float yMax = 10,
	       float xMax = 400+25,
	       TString Lumi = "35.9 fb^{-1}",
	       TString massLSP = "150",
	       TString massPart = "m(#tilde{#tau_{L}}) [GeV]",
	       bool blindData = true){
