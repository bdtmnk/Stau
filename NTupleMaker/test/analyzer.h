...
if (Mt2as>40 && Mt2as<120)
	...
	double dPhiTauMET=dPhiFrom2P( tauV.Px(), tauV.Py(), metx,  mety );
			...
			double retval = BDTResponseMutau_Stau100->GetMvaValue( *inputVec );
        	hBDTmutau_Stau100[CutIndex]->Fill( retval, EvWeight );       	
        	retval = BDTResponseMutau_Stau150->GetMvaValue( *inputVec );
        	hBDTmutau_Stau150[CutIndex]->Fill( retval, EvWeight );
        	retval = BDTResponseMutau_Stau200->GetMvaValue( *inputVec );
        	hBDTmutau_Stau200[CutIndex]->Fill( retval, EvWeight );
        	//retval = BDTResponseMutau_Stau300->GetMvaValue( *inputVec );
        	//hBDTmutau_Stau300[CutIndex]->Fill( retval, EvWeight );
        	
              //  retval = BDTResponseMutau_Stau90->GetMvaValue( *inputVec );
              //  hBDTmutau_Stau90[CutIndex]->Fill( retval, EvWeight );
               // retval = BDTResponseMutau_Stau250->GetMvaValue( *inputVec );
                //hBDTmutau_Stau250[CutIndex]->Fill( retval, EvWeight );
...
if (pzetavis !=0) dzetaR = pzetamiss/pzetavis;
	...
	double dPhiTauMET=dPhiFrom2P( tauV.Px(), tauV.Py(), metx,  mety );
			...
			double retval = BDTResponseEltau_Stau100->GetMvaValue( *inputVec );
        	hBDTeltau_Stau100[CutIndex]->Fill( retval, EvWeight );
        	retval = BDTResponseEltau_Stau150->GetMvaValue( *inputVec );
        	hBDTeltau_Stau150[CutIndex]->Fill( retval, EvWeight );        	
        	retval = BDTResponseEltau_Stau200->GetMvaValue( *inputVec );
        	hBDTeltau_Stau200[CutIndex]->Fill( retval, EvWeight );
        	//retval = BDTResponseEltau_Stau300->GetMvaValue( *inputVec );
        	//hBDTeltau_Stau300[CutIndex]->Fill( retval, EvWeight );
        	
              //  retval = BDTResponseEltau_Stau90->GetMvaValue( *inputVec );
              //  hBDTeltau_Stau90[CutIndex]->Fill( retval, EvWeight );
              //  retval = BDTResponseEltau_Stau250->GetMvaValue( *inputVec );
              //  hBDTeltau_Stau250[CutIndex]->Fill( retval, EvWeight );        	        	
...
//if (CutIndex==10 && bV.Pt()>0 && muV.Pt()>0)	cout<<"  cosTheta  "<<cosT<<"   "<<cosT2<<endl;
	...
	double dPhiJ=dPhiFrom2P( ta_px[tIndex], ta_py[tIndex], metx,  mety );
	...
	hTauPtEta[CutIndex]->Fill(ta_pt[tIndex],ta_eta[tIndex],EvWeight);
      }
...
analyzer::analyzer(TTree *tree) : fChain(0) 
{
  ...
  if (tree == 0) {
	...
	string name= "Stau200_LSP20_left.root";
	
	
    TString ChainName = "/nfs/dust/cms/user/bobovnii/MVAstau/CMSSW_8_0_25/src/DesyTauAnalyses/NTupleMaker/test/eltau/Stau200_LSP20_left.root/mutau/T";
    TString Tsystematic="METRecoilDown";
    ...
    if (string::npos == name.find("Single") && (Tsystematic == "JetEnUp" || Tsystematic == "JetEnDown" || Tsystematic == "UnclEnDown" || Tsystematic == "UnclEnDown" || Tsystematic == "TauEnUp" || Tsystematic == "TauEnDown" || Tsystematic == "ElEnUp" || Tsystematic == "ElEnDown" || Tsystematic == "MuEnUp" || Tsystematic == "MuEnDown" || Tsystematic == "BTagUp" || Tsystematic == "BTagDown")) 
      ChainName ="/nfs/dust/cms/user/bobovnii/MVAstau/CMSSW_8_0_25/src/DesyTauAnalyses/NTupleMaker/test/eltau_"+Tsystematic+"/Stau200_LSP20_left.root/mutau/T";				
