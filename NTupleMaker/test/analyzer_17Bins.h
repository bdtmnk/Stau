...
*/
		...
		void FillHists(int CutIndex, Double_t EvWeight, TLorentzVector  elV, TLorentzVector  muV, TLorentzVector tauV, vector<TLorentzVector>  &JetsV, TLorentzVector  &MetV, double Chimass, double mintermediate, string & Sel, int  mIndex, int eIndex, int  tIndex, int category){


//cout<<" check out  "<<Sel<<"  "<<CutIndex<<"  "<<mIndex<<"  "<<tIndex<<"  "<<category<<endl;

			hnJetFake[CutIndex][category]->Fill(njets,EvWeight);
...
///////////////////mutau
			...
			if (Sel=="mutau" && mIndex >-1 && tIndex>-1 ){
				...
				hMt2lesterFake[CutIndex][category]->Fill(Mt2as,EvWeight);
				...
				hDZetaFake[CutIndex][category]->Fill(dzeta,EvWeight);
			...
			if (mIndex !=-1 )
			{
				...
				hMuptFake[CutIndex][category]->Fill(mu_pt[mIndex],EvWeight);
...
/////////////global variables
			...
			if (MetV.Pt()>0. ) {
				...
				hMETFake[CutIndex][category]->Fill(MetV.Pt(),EvWeight);
			}
...
////////////////////////////////////////////////
			...
			if (met<40 ){
				...
				if (Mt2as<40) 	{
					if (dzeta<-100) {hmet_MT2lester_DZeta_1D[CutIndex]->Fill(1,EvWeight); }
					if (dzeta>-100) {hmet_MT2lester_DZeta_1D[CutIndex]->Fill(2,EvWeight); }
				}
				if (Mt2as>40) 	{
					if (dzeta<-100) {hmet_MT2lester_DZeta_1D[CutIndex]->Fill(5,EvWeight); }
					if (dzeta>-100) {hmet_MT2lester_DZeta_1D[CutIndex]->Fill(6,EvWeight); }
				}
			...
			if (met>40 && met<80){
				if (Mt2as<40) 	{
					if (dzeta<-100) {hmet_MT2lester_DZeta_1D[CutIndex]->Fill(7,EvWeight); }
					if (dzeta>-100 && dzeta<50) {hmet_MT2lester_DZeta_1D[CutIndex]->Fill(9,EvWeight); }
					if (dzeta>50) {hmet_MT2lester_DZeta_1D[CutIndex]->Fill(10,EvWeight); }
				}
				if (Mt2as>40 && Mt2as<80) 	{
					if (dzeta<-150) {hmet_MT2lester_DZeta_1D[CutIndex]->Fill(11,EvWeight); }
					if (dzeta>-150 && dzeta<-100) {hmet_MT2lester_DZeta_1D[CutIndex]->Fill(12,EvWeight); }
					if (dzeta>-100) {hmet_MT2lester_DZeta_1D[CutIndex]->Fill(13,EvWeight); }
				}

				if (Mt2as>80 ) 	{
					{hmet_MT2lester_DZeta_1D[CutIndex]->Fill(14,EvWeight); }
				}
			...
			if (met>80 && met<120){
				if (Mt2as<40) 	{
					if (dzeta<-100) {hmet_MT2lester_DZeta_1D[CutIndex]->Fill(15,EvWeight); }
					if (dzeta>-100) {hmet_MT2lester_DZeta_1D[CutIndex]->Fill(16,EvWeight); }
				}
				if (Mt2as>40 && Mt2as<80) 	{
					if (dzeta<-150) {hmet_MT2lester_DZeta_1D[CutIndex]->Fill(17,EvWeight); }
					if (dzeta>-150 && dzeta<-100) {hmet_MT2lester_DZeta_1D[CutIndex]->Fill(18,EvWeight); }
					if (dzeta>-100) {hmet_MT2lester_DZeta_1D[CutIndex]->Fill(19,EvWeight); }
				}

				if (Mt2as>80 && Mt2as<120) 	{
					{hmet_MT2lester_DZeta_1D[CutIndex]->Fill(20,EvWeight); }
				}
				if (Mt2as>120) 	{
					{hmet_MT2lester_DZeta_1D[CutIndex]->Fill(21,EvWeight); }
				}
			...
			if (met>120){
				...
				if (Mt2as<40) 	{
					if (dzeta<-150) {hmet_MT2lester_DZeta_1D[CutIndex]->Fill(22,EvWeight); }
					if (dzeta>-150 && dzeta<-100) {hmet_MT2lester_DZeta_1D[CutIndex]->Fill(23,EvWeight); }
					if (dzeta>-100) {hmet_MT2lester_DZeta_1D[CutIndex]->Fill(24,EvWeight); }
				}
				if (Mt2as>40 && Mt2as<80) 	{
					if (dzeta<-150) {hmet_MT2lester_DZeta_1D[CutIndex]->Fill(25,EvWeight); }
					if (dzeta>-150 && dzeta<-100) {hmet_MT2lester_DZeta_1D[CutIndex]->Fill(26,EvWeight); }
					if (dzeta>-100) {hmet_MT2lester_DZeta_1D[CutIndex]->Fill(27,EvWeight); }
				}

				if (Mt2as>80 && Mt2as<120) 	{
					{hmet_MT2lester_DZeta_1D[CutIndex]->Fill(28,EvWeight); }
				}
				if (Mt2as>120) 	{
					hmet_MT2lester_DZeta_1D[CutIndex]->Fill(29,EvWeight); 
				}
...
///////////////////////
			...
			if (met<40){
				...
				if (Mt2as<40) 	{
					{hmet_MT2lester_DZeta_0J1D[CutIndex]->Fill(1,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(1,EvWeight);}
				}
				if (Mt2as>40) 	{
					{hmet_MT2lester_DZeta_0J1D[CutIndex]->Fill(2,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(2,EvWeight);}
				}
			...
			if (met>40 && met<80){
				if (Mt2as<40) 	{
					 {hmet_MT2lester_DZeta_0J1D[CutIndex]->Fill(3,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(3,EvWeight);}
				}
				if (Mt2as>40 && Mt2as<80) 	{
					 {hmet_MT2lester_DZeta_0J1D[CutIndex]->Fill(4,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(4,EvWeight);}
				}

				if (Mt2as>80 ) 	{
					{hmet_MT2lester_DZeta_0J1D[CutIndex]->Fill(5,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(5,EvWeight);}
				}
			...
			if (met>80 && met<120){
				if (Mt2as<40) 	{
					 {hmet_MT2lester_DZeta_0J1D[CutIndex]->Fill(12,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(6,EvWeight);}
				}
				if (Mt2as>40 && Mt2as<80) 	{
					if (dzeta<-100) {hmet_MT2lester_DZeta_0J1D[CutIndex]->Fill(7,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(7,EvWeight);}
					if (dzeta>-100) {hmet_MT2lester_DZeta_0J1D[CutIndex]->Fill(8,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(8,EvWeight);}
				}
				...
				if (Mt2as>120) 	{
					{hmet_MT2lester_DZeta_0J1D[CutIndex]->Fill(10,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(10,EvWeight);}
				}
			...
			if (met>120){
				...
				if (Mt2as<40) 	{
					...
					if (dzeta>-100 && dzeta<0) {hmet_MT2lester_DZeta_0J1D[CutIndex]->Fill(12,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(12,EvWeight);}
					if (dzeta>0) {hmet_MT2lester_DZeta_0J1D[CutIndex]->Fill(13,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(13,EvWeight);}
				}
				if (Mt2as>40 && Mt2as<80) 	{
					if (dzeta<-100) {hmet_MT2lester_DZeta_0J1D[CutIndex]->Fill(14,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(14,EvWeight);}
					if (dzeta>-100) {hmet_MT2lester_DZeta_0J1D[CutIndex]->Fill(15,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(15,EvWeight);}
				}

				if (Mt2as>80 && Mt2as<120) 	{
					{hmet_MT2lester_DZeta_0J1D[CutIndex]->Fill(16,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(16,EvWeight);}
				}
				if (Mt2as>120) 	{
					hmet_MT2lester_DZeta_0J1D[CutIndex]->Fill(17,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(17,EvWeight);
				}
...
///////////////////////
			...
			if (met<40){
				...
				if (Mt2as<40) 	{
					{hmet_MT2lester_DZeta_1J1D[CutIndex]->Fill(1,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(1+nB,EvWeight);}
				}
				if (Mt2as>40) 	{
					{hmet_MT2lester_DZeta_1J1D[CutIndex]->Fill(2,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(2+nB,EvWeight);}
				}
			...
			if (met>40 && met<80){
				if (Mt2as<40) 	{
					 {hmet_MT2lester_DZeta_1J1D[CutIndex]->Fill(3,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(3+nB,EvWeight);}
				}
				if (Mt2as>40 && Mt2as<80) 	{
					 {hmet_MT2lester_DZeta_1J1D[CutIndex]->Fill(4,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(4+nB,EvWeight);}
				}

				if (Mt2as>80 ) 	{
					{hmet_MT2lester_DZeta_1J1D[CutIndex]->Fill(5,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(5+nB,EvWeight);}
				}
			...
			if (met>80 && met<120){
				if (Mt2as<40) 	{
					 {hmet_MT2lester_DZeta_1J1D[CutIndex]->Fill(12,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(6+nB,EvWeight);}
				}
				if (Mt2as>40 && Mt2as<80) 	{
					if (dzeta<-100) {hmet_MT2lester_DZeta_1J1D[CutIndex]->Fill(7,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(7+nB,EvWeight);}
					if (dzeta>-100) {hmet_MT2lester_DZeta_1J1D[CutIndex]->Fill(8,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(8+nB,EvWeight);}
				}
				...
				if (Mt2as>120) 	{
					{hmet_MT2lester_DZeta_1J1D[CutIndex]->Fill(10,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(10+nB,EvWeight);}
				}
			...
			if (met>120){
				...
				if (Mt2as<40) 	{
					...
					if (dzeta>-100 && dzeta<0) {hmet_MT2lester_DZeta_1J1D[CutIndex]->Fill(12,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(12+nB,EvWeight);}
					if (dzeta>0) {hmet_MT2lester_DZeta_1J1D[CutIndex]->Fill(13,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(13+nB,EvWeight);}
				}
				if (Mt2as>40 && Mt2as<80) 	{
					if (dzeta<-100) {hmet_MT2lester_DZeta_1J1D[CutIndex]->Fill(14,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(14+nB,EvWeight);}
					if (dzeta>-100) {hmet_MT2lester_DZeta_1J1D[CutIndex]->Fill(15,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(15+nB,EvWeight);}
				}

				if (Mt2as>80 && Mt2as<120) 	{
					{hmet_MT2lester_DZeta_1J1D[CutIndex]->Fill(16,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(16+nB,EvWeight);}
				}
				if (Mt2as>120) 	{
					hmet_MT2lester_DZeta_1J1D[CutIndex]->Fill(17,EvWeight); hmet_MT2lester_DZeta_01J1D[CutIndex]->Fill(17+nB,EvWeight);
				}
