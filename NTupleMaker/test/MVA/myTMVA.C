...
#include "/nfs/dust/cms/user/bobovnii/new/CMSSW_8_0_20/src/DesyTauAnalyses/NTupleMaker/test/MVA/weights/ForUse/myTMVA_MLP1_B0001.class.C"
//#include "analyzer.h"
...
int myTMVA( TString myMethodList = "", 
		...
		float EntriesProc = 0.3,
		float EntriesProcTest = 0.2, /// from EntriesProc!!!!!
...
//                                               "!V:!Silent:Color:DrawProgressBar:Transformations=I;D;P;G,D:AnalysisType=Classification" );
   ...
   factory->AddVariable( "Lept1Pt", "Lept1Pt", "", 'F' );
   factory->AddVariable( "Lept2Pt", "Lept2Pt", "units", 'F' );
   //factory->AddVariable( "njets", "njets", "units", 'I' );
   factory->AddVariable( "EtaDil", "EtaDil", "units", 'F' );
   factory->AddVariable( "MTtot", "MTtot", "units", 'F' );
   factory->AddVariable( "Dzeta", "Dzeta", "units", 'F' );
   factory->AddVariable( "Minv", "Minv", "units", 'F' );
   factory->AddVariable( "dR", "dR", "units", 'F' );
   factory->AddVariable( "MT", "MT", "units", 'F' );
   factory->AddVariable( "MCTb", "MCTb", "units", 'F' );
   factory->AddVariable( "MT2lester", "MT2lester", "units", 'F' );
   factory->AddVariable( "dMETPhiL1", "dMETPhiL1", "units", 'F' );
   factory->AddVariable( "dMETPhiL2", "dMETPhiL2", "units", 'F' );


/*
   factory->AddVariable( "mu_eta", "mu_eta", "units", 'F' );
   factory->AddVariable( "tau_eta", "tau_eta", "units", 'F' );
   factory->AddVariable( "dEtaJMu", "dEtaJMu", "units", 'F' );
   factory->AddVariable( "dEtaJTau", "dEtaJTau", "units", 'F' );
   factory->AddVariable( "mu_dz", "mu_dz", "units", 'F' );
   factory->AddVariable( "mu_dxy", "mu_dxy", "units", 'F' );
   factory->AddVariable( "dPhiDiL", "dPhiDiL", "units", 'F' );
   factory->AddVariable( "dR_taujet", "dR_taujet", "units", 'F' );*/
/*
   factory->AddVariable( "HTOsqrMET", "HTOsqrMET", "units", 'F' );
   factory->AddVariable( "PtJ0", "PtJ0", "units", 'F' );
*/
/*
   factory->AddVariable( "nEl", "nEl", "units", 'I' );
   factory->AddVariable( "nTau", "nTau", "units", 'I' );
   factory->AddVariable( "nMu", "nMu", "units", 'I' );
*/
   ...
   //factory->AddVariable( "", "", "units", 'F' );
   //factory->AddVariable( "", "", "units", 'F' );
   std::vector<std::string> inputVars = {"met_pt","Lept1Pt","Lept2Pt","EtaDil","MTtot","Dzeta","Minv","dR","MT","MCTb","MT2lester","dMETPhiL1","dMETPhiL2"};
   IClassifierReader* ANNResponse = new ReadMLP1_B0001( inputVars );
...
TH1D *hMt2lestermutau = new TH1D ("Mt2lestermutauFB_","Mt2lestermutau ",100,2,302);
	...
	string line;
		...
		if (std::string::npos != HHname.find(stau) && Sxsec < 0.9) {name2 = WorkDir+channel+"/"+Signal+".root"; name=Signal;HHname=Signal;xs=Sxsec;}
       		cout << i << endl;
       		cout << name << endl; 
		name3 = name;
		//treeName = "tree"+name;
  ...
  treeName->SetBranchAddress("npartons",&npartons,&b_npartons);
		...
		//if (std::string::npos != HHname.find(stau)) {EntriesProc=1; EntriesProcTest=0.15;}
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 	END FILLING
   ...
   if (Use["MLP1"])
      factory->BookMethod( TMVA::Types::kMLP, "MLP1", "H:!V:NeuronType=sigmoid:VarTransform=N:NCycles=600:HiddenLayers=N+5:TestRate=5" );
   ...
   if (Use["MLP2"])
      ...
      factory->BookMethod( TMVA::Types::kMLP, "MLP1", "Boost_Num=10:Boost_Type=AdaBoost:Boost_Transform=step:Boost_AdaBoostBeta=0.1:H:!V:NeuronType=sigmoid:VarTransform=N:NCycles=600:HiddenLayers=N+5:TestRate=5" );
   ...
   if (Use["MLP3"])
      ...
      factory->BookMethod( TMVA::Types::kMLP, "MLP1", "Boost_Num=100:Boost_Type=AdaBoost:Boost_Transform=step:Boost_AdaBoostBeta=0.1:H:!V:NeuronType=sigmoid:VarTransform=N:NCycles=600:HiddenLayers=N+5:TestRate=5" );
   ...
   if (Use["MLP4"])
      ...
      factory->BookMethod( TMVA::Types::kMLP, "MLP1", "Boost_Num=10:Boost_Type=AdaBoost:Boost_Transform=linear:Boost_AdaBoostBeta=0.1:H:!V:NeuronType=sigmoid:VarTransform=N:NCycles=600:HiddenLayers=N+5:TestRate=5" );
   ...
   if (Use["MLP5"])
      ...
      factory->BookMethod( TMVA::Types::kMLP, "MLP1", "Boost_Num=10:Boost_Type=AdaBoost:Boost_Transform=log:Boost_AdaBoostBeta=0.1:H:!V:NeuronType=sigmoid:VarTransform=N:NCycles=600:HiddenLayers=N+5:TestRate=5" );
   ...
   if (Use["MLP6"])
      ...
      factory->BookMethod( TMVA::Types::kMLP, "MLP1", "Boost_Num=10:Boost_Type=Bagging:H:!V:NeuronType=sigmoid:VarTransform=N:NCycles=600:HiddenLayers=N+5:TestRate=5" );
   ...
   if (Use["MLPBFGS1"])
      factory->BookMethod( TMVA::Types::kMLP, "MLPBFGS1", "Boost_Num=10:Boost_Type=AdaBoost:Boost_Transform=step:Boost_AdaBoostBeta=0.1:H:!V:NeuronType=tanh:VarTransform=N:NCycles=1000:HiddenLayers=N+5:TestRate=5:TrainingMethod=BFGS:!UseRegulator" );
   ...
   if (Use["MLPBNN"])
      factory->BookMethod( TMVA::Types::kMLP, "MLPBNN", "Boost_Num=10:Boost_Type=AdaBoost:Boost_Transform=step:H:!V:NeuronType=tanh:VarTransform=N:NCycles=600:HiddenLayers=N+5:TestRate=5:TrainingMethod=BFGS:UseRegulator" ); // BFGS training with bayesian regulators

   if (Use["MLPBNN1"])
      factory->BookMethod( TMVA::Types::kMLP, "MLPBNN1", "Boost_Num=10:Boost_Type=AdaBoost:Boost_Transform=step:Boost_AdaBoostBeta=0.1:H:!V:NeuronType=tanh:VarTransform=N:NCycles=1000:HiddenLayers=N+5:TestRate=5:TrainingMethod=BFGS:UseRegulator" ); // BFGS training with bayesian regulators
...
*/
   ...
   if (Use["BDT"+BDTname])  // Adaptive Boost
      {factory->BookMethod( TMVA::Types::kBDT, "BDT"+BDTname,
        //                   "!H:!V:NTrees=850:MinNodeSize=2.5%:MaxDepth=3:BoostType=AdaBoost:AdaBoostBeta=0.5:UseBaggedBoost:BaggedSampleFraction=0.5:SeparationType=SDivSqrtSPlusB:nCuts=20"/*:NegWeightTreatment=Pray*/ );
		//BDTmutau->SkipNormalization("false");
		                           "!H:!V:NTrees=850:MinNodeSize=0.25%:MaxDepth=3:BoostType=AdaBoost:AdaBoostBeta=0.5:UseBaggedBoost:BaggedSampleFraction=0.5:SeparationType=GiniIndex:nCuts=20"/*:NegWeightTreatment=Pray*/ );
