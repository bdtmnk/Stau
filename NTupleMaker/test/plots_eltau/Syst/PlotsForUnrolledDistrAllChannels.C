...
//WithoutNPV/
void PlotsForUnrolledDistrAllChannels(TString directory = "",
...
//		BinLabels[i]=name;
    ...
    filee = new TFile("/nfs/dust/cms/user/alkaloge/Workdir/CMSSW_8_1_0/src/Limits/Results_SR_CR1/fitDiagnostics_met_MT2lester_DZeta01J1D_17_all.root","read");
    fileStat = new TFile("/nfs/dust/cms/user/alkaloge/TauAnalysis/new/new/StauAnalysis/New8025/CMSSW_8_0_25/src/DesyTauAnalyses/NTupleMaker/test/Processing/01Jets/MuTau/SR_CR1_MuTau.root","read");
...
*/
    ...
    TH1D * histSignal2 = (TH1D*)file->Get("C1N2_400_LSP175_B_"+Variable);
    TH1D * histSignal3 = (TH1D*)file->Get("stau-stau_left_90_LSP1_B_"+Variable);
    TH1D * histSignal4 = (TH1D*)file->Get("ChiWH_400_LSP200_B_"+Variable);
...
//   legend->AddEntry(histSignal4,"ChiWH_400_LSP_200","ple");
...
if (OverlayFit)   bkgdErr->Draw("e2same");
    ...
    legend->AddEntry(bkgdErr, "Bkg uncertainty pre-fit" , "F" );
    canv1->Update();
