...
void OverlapTauFakes(string syst="Nominal")
{
	...
	string np_title = titles[0];
				...
				if (s_!="Nominal") app_="_"+s_;
					...
					WInclname = "WJetsToLNu_TuneCP5_13TeV-12Apr2018"+app_+"_Nominal_A.root";
					W1Jname = "W1JetsToLNu_TuneCP5_13TeV-12Apr2018"+app_+"_Nominal_A.root";
					W2Jname = "W2JetsToLNu_TuneCP5_13TeV-12Apr2018"+app_+"_Nominal_A.root";
					W3Jname = "W3JetsToLNu_TuneCP5_13TeV-12Apr2018"+app_+"_Nominal_A.root";
					W4Jname = "W4JetsToLNu_TuneCP5_13TeV-12Apr2018"+app_+"_Nominal_A.root";

					DYInclname = "DYJetsToLL_M-50_13TeV-12Apr2018"+app_+"_Nominal_A.root";
					DY1Jname = "DY1JetsToLL_M-50_13TeV-12Apr2018"+app_+"_Nominal_A.root";
					DY2Jname = "DY2JetsToLL_M-50_13TeV-12Apr2018"+app_+"_Nominal_A.root";
					DY3Jname = "DY3JetsToLL_M-50_13TeV-12Apr2018"+app_+"_Nominal_A.root";
					DY4Jname = "DY4JetsToLL_M-50_13TeV-12Apr2018"+app_+"_Nominal_A.root";
...
Impose (TDirectory * target, TList * sourcelist, string & np_title_, vector<string> titles,vector<float> xsecs)
{
	...
	while ((key = (TKey *) nextkey ())) {
        ...
        //if (string::npos == nn.find("METFB_17")) flcont=false;
        if (string::npos == nn.find("CutFlowUnW") && string::npos == nn.find("_6") && string::npos == nn.find("_7") && string::npos == nn.find("_8") && string::npos == nn.find("_9") && string::npos == nn.find("_10") && string::npos == nn.find("_11") && string::npos == nn.find("_15") && string::npos == nn.find("_14")  && string::npos == nn.find("_13") && string::npos == nn.find("_16") && string::npos == nn.find("_12") && string::npos == nn.find("histWeightsH") && string::npos == nn.find("_17") && string::npos == nn.find("_18")) flcont=false;
		...
		c1->SetTitle(obj->GetName());
			...
			while (nextsource) {
				...
				nextsource->cd("eltau");
				TH1D* eventCountt ;
				  //if  ( std::string::npos == fname.find("TTT")) eventCountt = (TH1D*)nextsource->Get("eltau/histWeightsH");
				  //if ( std::string::npos != fname.find("TTT") ) eventCountt = (TH1D*)nextsource->Get("eltau/histTopPt");
				eventCountt = (TH1D*)nextsource->Get("eltau/histWeightsH");
				float normm =1.;
				TH1D* hxsecc = (TH1D*)nextsource->Get("eltau/xsec");
...
/*
	...
	filee->cd("eltau");
	//target->ls();
	TH1D * hcut = (TH1D*)filee->Get("eltau/CutFlowUnW");
