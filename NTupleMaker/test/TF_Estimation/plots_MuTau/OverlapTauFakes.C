...
void OverlapTauFakes(string syst="Nominal")
{
	...
	string np_title = titles[0];
				...
				if (s_!="Nominal") app_="_"+s_;
					...
					WInclname = "WJetsToLNu_TuneCP5_13TeV-12Apr2018"+app_;//+"Nominal_A.root";
					W1Jname = "W1JetsToLNu_TuneCP5_13TeV-12Apr2018"+app_;//+"Nominal_A.root";
					W2Jname = "W2JetsToLNu_TuneCP5_13TeV-12Apr2018"+app_;//+"Nominal_A.root";
					W3Jname = "W3JetsToLNu_TuneCP5_13TeV-12Apr2018"+app_;//+"Nominal_A.root";
					W4Jname = "W4JetsToLNu_TuneCP5_13TeV-12Apr2018"+app_;//+"Nominal_A.root";

					DYInclname = "DYJetsToLL_M-50_13TeV-12Apr2018"+app_;//+"Nominal_A.root";
					DY1Jname = "DY1JetsToLL_M-50_13TeV-12Apr2018"+app_;//+"Nominal_A.root";
					DY2Jname = "DY2JetsToLL_M-50_13TeV-12Apr2018"+app_;//+"Nominal_A.root";
					DY3Jname = "DY3JetsToLL_M-50_13TeV-12Apr2018"+app_;//+"Nominal_A.root";
					DY4Jname = "DY4JetsToLL_M-50_13TeV-12Apr2018"+app_;//+"Nominal_A.root";
...
//
	...
	while ((key = (TKey *) nextkey ())) {
		...
		bool flcont=true;
		// << nn<<"  "<< flcont<< "  AAAAAAAAAAAAAaa"<<  endl;

        	if (string::npos == nn.find("_15") && string::npos == nn.find("histWeightsH") && string::npos == nn.find("_16")) flcont=false;
        //if (string::npos == nn.find("CutFlowUnW") && string::npos == nn.find("_9")  && string::npos == nn.find("_10") && string::npos == nn.find("_11")  && string::npos == nn.find("_12") && string::npos == nn.find("_13")  && string::npos == nn.find("_15") && string::npos == nn.find("_14")  && string::npos == nn.find("_16") && string::npos == nn.find("histWeightsH") && string::npos == nn.find("_17") && string::npos == nn.find("_18")  && string::npos == nn.find("_19")) flcont=false;
		...
		c1->SetTitle(obj->GetName());
			...
			while (nextsource) {
				...
				TH1D* eventCountt ;
				  //if  ( std::string::npos == fname.find("TTT")) eventCountt = (TH1D*)nextsource->Get("mutau/histWeightsH");
				  //if ( std::string::npos != fname.find("TTT") ) eventCountt = (TH1D*)nextsource->Get("mutau/histTopPt");
				eventCountt = (TH1D*)nextsource->Get("mutau/histWeightsH");
				cout<<"Event count"<<eventCountt<<endl;
				float normm =1.;
...
void ModifyHist (TH1D* &h, int cl_ ,float & lumi,float & weight,string & title_){
