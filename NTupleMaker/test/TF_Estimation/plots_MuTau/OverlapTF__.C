...
*/
		...
		c1->SetTitle(obj->GetName());
			...
			h1->SetStats(000000);
			h1->SetLineWidth(5);
cout <<"begin  "<< h1->GetSumOfWeights() << endl;
			hh[cl]=h1;
...
cout << errorD<<endl;
        ...
        fout<<"        if (pt>30) SF = "<<ratio->GetBinContent(2,3)<<";" <<endl;
        ...
        cout<<"         if (pt>40 ) SF = "<<ratio->GetBinError(3,1)<<";" <<endl;
                cout<<"         if (pt>70 ) SF = "<<ratio->GetBinError(4,1)<<";" <<endl;
        ...
        cout<<"         if (pt>40 ) SF = "<<ratio->GetBinError(3,2)<<";" <<endl;
                cout<<"         if (pt>70 ) SF = "<<ratio->GetBinError(4,2)<<";" <<endl;
        ...
        cout<<"         if (pt>40 ) SF = "<<ratio->GetBinError(3,3)<<";" <<endl;
                cout<<"         if (pt>70 ) SF = "<<ratio->GetBinError(4,3)<<";" <<endl;
        ...
        cout<<"         if (pt>40 ) SF = "<<ratio->GetBinError(3,4)<<";" <<endl;
                cout<<"         if (pt>70 ) SF = "<<ratio->GetBinError(4,4)<<";" <<endl;
