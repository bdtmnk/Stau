...
cout << "Selection"<< 
	...
	" & " <<setprecision(1)<< fixed<<setprecision(1)<< fixed<< BDT1->GetBinContent(25) *(xsec1*lumi)/Weights1->GetSumOfWeights()  << 
	" & " <<setprecision(1)<< fixed<<BDT2->GetBinContent(25) *(xsec2*lumi)/Weights2->GetSumOfWeights() << 
	" & " <<setprecision(1)<< fixed<< BDT3->GetBinContent(28) *(xsec3*lumi)/Weights3->GetSumOfWeights()  << 
	"\\\\" <<
	endl;
