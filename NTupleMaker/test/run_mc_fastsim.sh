...
cd /nfs/dust/cms/user/alkaloge/TauAnalysis/new/new/CMSSW_8_0_25/src/DesyTauAnalyses/NTupleMaker/test ;  eval `scramv1 runtime -sh` ;
cd -
...
do
	...
	echo "cd /nfs/dust/cms/user/alkaloge/TauAnalysis/new/new/StauAnalysis/New8025/CMSSW_8_0_25/src/DesyTauAnalyses/NTupleMaker/test/FastSim_Stau/"
