...
wdir="/nfs/dust/cms/user/bobovnii/MVAstau/CMSSW_8_0_25/src/DesyTauAnalyses/NTupleMaker/test"
channel=$2 
...
chmod u+x $wdir/Jobs/job${channel}${line}$dir${bas}_B${syst}.sh
 qsub -l h_rt=0:30:00 -l h_cpu=4000M -e /dev/null -o /dev/null $wdir/Jobs/job${channel}${line}$dir${bas}_B${syst}.sh 
fi
