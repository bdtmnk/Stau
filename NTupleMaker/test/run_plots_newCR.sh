...
dir="/nfs/dust/cms/user/bobovnii/MVAstau/CMSSW_8_0_25/src/DesyTauAnalyses/NTupleMaker/test"
...
#systematics="Nominal JetEnUp JetEnDown  ZPtUp ZPtDown TauEnUp TauEnDown ElEnUp ElEnDown MuEnUp MuEnDown UnclEnUp UnclEnDown genMET ScalesDown ScalesUp PDFUp PDFDown"
...
if [[  $3 == "listTT" ]];then
systematics="Nominal JetEnUp JetEnDown  ZPtUp ZPtDown ElEnUp ElEnDown MuEnUp MuEnDown UnclEnUp UnclEnDown ScalesDown ScalesUp PDFUp PDFDown BTagUp BTagDown METRecoilUp METRecoilDown"
#systematics="JetEnUp JetEnDown ElEnUp ElEnDown MuEnUp MuEnDown UnclEnUp UnclEnDown BTagUp BTagDown"
#systematics="Nominal   ZPtUp ZPtDown ElEnUp ElEnDown MuEnUp MuEnDown UnclEnUp UnclEnDown ScalesDown ScalesUp PDFUp PDFDown BTagUp BTagDown METRecoilUp METRecoilDown"
fi
...
if [[  $3 == "listWJ" ]];then
systematics="Nominal ZpTUp ZPtDown  JetEnUp JetEnDown MuEnUp MuEnDown UnclEnUp UnclEnDown ScalesDown ScalesUp PDFUp PDFDown METRecoilUp METRecoilDown  BTagUp BTagDown"
...
if [[ $line == *"LSP"* || $line == *"C1"* || $line == *"Chi"* ]] ; then
...
if [[ $file == *"B_OS"*  ]] || [[ $file == *"LSP"* ]] &&  [[ ! -f $dir/plots_$channel/${fileB}_B.root ]] ; then
#if true ; then
...
cp $dir/analyzer${channel}CR_C analyzer.C
...
if [[ ! -f $dir/plots_$channel/${fileB}_A.root ]] && [[ $file != *"LSP"* && $file != *"C1"*  &&  $file != *"Chi"* && $2 != "Ttemplate" && $2 != "mumu" && $2 != "WJETSMU"    &&  $2 != *"fakesmu"*  &&  $2 != *"WJetsCR"*   ]] ;then
echo Start!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
