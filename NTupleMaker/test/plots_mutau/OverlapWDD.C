...
//		if ( string::npos == nn.find("CutFlowUnW")) flcont=false;
	...
	//	if (string::npos == nn.find("_17")) flcont=false;
//		if ( string::npos == nn.find("nJet") || string::npos == nn.find("_15") && string::npos == nn.find("_14")  && string::npos == nn.find("_13") && string::npos == nn.find("_16") && string::npos == nn.find("_17") && string::npos == nn.find("_18")  && string::npos == nn.find("_19")) flcont=false;

//if (string::npos == nn.find("_18") && string::npos == nn.find("_17"))  flcont=false;
		if (!flcont) continue;
		...
		//	cout << h2->GetSumOfWeights()<<endl;
						...
						if (cl==2){
							...
							hqcd->Reset();
									...
									//
								//<< " for "<<fname<<"  "<<" SuOfWeights "<<nGenn<<" Lumi "<<Lumi<<" lumiweight "<<lumiweights[cl-1]<<" weight "<<float(xsecc*Lumi/nGenn)<<"  norm "<<normm<<" cl "<<cl<<"  "<<h2->GetSumOfWeights()<<"  "<<h2->GetBinContent(25)<<endl;
