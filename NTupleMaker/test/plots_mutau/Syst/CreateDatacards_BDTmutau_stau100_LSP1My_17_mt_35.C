#include <math.h>
#include <iostream>
void CreateDatacards_BDTmutau_stau100_LSP1My_17_mt_35() {
...
bool bFirst = false;
  ...
  //TFile * file = new TFile("Var_BDTmutau_stau100_LSP1My_17_35invfb_mt_Syst");
  TFile *file = TFile::Open ("Var_BDTmutau_stau100_LSP1My_17_35invfb_mt_Syst.root", "read");
  TFile *fileout = TFile::Open ("Var_BDTmutau_stau100_LSP1My_17_35invfb_mt_Syst_out.root", "update");
  //file->cd("mt");
  

  TH1D * data_obs = (TH1D*)file->Get("data_obs_BDTmutau_stau100_LSP1My_17");
//  TH1D * data_obs = (TH1D*)file->Get("allbkg_BDTmutau_stau100_LSP1My_17");

  data_obs->SetName("data_obs");

  TH1D * signal = (TH1D*)file->Get("stau-stau_left_90_LSP10_B_BDTmutau_stau100_LSP1My_17");
  ...
  TH1D * tt = (TH1D*)file->Get("tt_BDTmutau_stau100_LSP1My_17");
  TH1D * wj = (TH1D*)file->Get("wj_BDTmutau_stau100_LSP1My_17");
  TH1D * dyj = (TH1D*)file->Get("dyj_BDTmutau_stau100_LSP1My_17");
  TH1D * ztt = (TH1D*)file->Get("ztt_BDTmutau_stau100_LSP1My_17");
  TH1D * dib = (TH1D*)file->Get("dib_BDTmutau_stau100_LSP1My_17");
  TH1D * ww = (TH1D*)file->Get("ww_BDTmutau_stau100_LSP1My_17");
  TH1D * ttx = (TH1D*)file->Get("ttx_BDTmutau_stau100_LSP1My_17");
  TH1D * sT = (TH1D*)file->Get("sT_BDTmutau_stau100_LSP1My_17");
  TH1D * fakes = (TH1D*)file->Get("fakes_BDTmutau_stau100_LSP1My_17");
  TH1D * rest = (TH1D*)file->Get("rest_BDTmutau_stau100_LSP1My_17");
...
if (bFirst){
  ...
  for (int iB=1; iB<=nBins; ++iB) {
    TH1D * ttUp = (TH1D*)tt->Clone("tt_BDTmutau_stau100_LSP1My_17_ttBin"+binName[iB]+"Up");
    TH1D * ttDown = (TH1D*)tt->Clone("tt_BDTmutau_stau100_LSP1My_17_ttBin"+binName[iB]+"Down");
...
if (xtt-ett>0. && rtt>ttUnc) { ttDown->SetBinContent(iB,xtt-ett);ttDown->SetBinError(iB,sqrt(ttDown->GetBinContent(iB)));}
    ...
    ttUp->Write("tt_BDTmutau_stau100_LSP1My_17_ttBin_mt"+binName[iB]+"Up");
    ttDown->Write("tt_BDTmutau_stau100_LSP1My_17_ttBin_mt"+binName[iB]+"Down");

    TH1D * WUp = (TH1D*)wj->Clone("wj_BDTmutau_stau100_LSP1My_17_wjBin"+binName[iB]+"Up");
    TH1D * WDown = (TH1D*)wj->Clone("wj_BDTmutau_stau100_LSP1My_17_wjBin"+binName[iB]+"Down");
...
if (xwj-ewj>0. && rwj>wjUnc) { WDown->SetBinContent(iB,xwj-ewj);WDown->SetBinError(iB,sqrt(WDown->GetBinContent(iB)));}
    ...
    WUp->Write("wj_BDTmutau_stau100_LSP1My_17_wjBin_mt"+binName[iB]+"Up");
    WDown->Write("wj_BDTmutau_stau100_LSP1My_17_wjBin_mt"+binName[iB]+"Down");

    TH1D * dyjUp = (TH1D*)dyj->Clone("dyj_BDTmutau_stau100_LSP1My_17_dyjBin"+binName[iB]+"Up");
    TH1D * dyjDown = (TH1D*)dyj->Clone("dyj_BDTmutau_stau100_LSP1My_17_dyjBin"+binName[iB]+"Down");
...
if (xdyj-edyj>0. && rdyj>dyjUnc) { dyjDown->SetBinContent(iB,xdyj-edyj);dyjDown->SetBinError(iB,sqrt(dyjDown->GetBinContent(iB)));}
    ...
    dyjUp->Write("dyj_BDTmutau_stau100_LSP1My_17_dyjBin_mt"+binName[iB]+"Up");
    dyjDown->Write("dyj_BDTmutau_stau100_LSP1My_17_dyjBin_mt"+binName[iB]+"Down");

    TH1D * zttUp = (TH1D*)ztt->Clone("ztt_BDTmutau_stau100_LSP1My_17_zttBin"+binName[iB]+"Up");
    TH1D * zttDown = (TH1D*)ztt->Clone("ztt_BDTmutau_stau100_LSP1My_17_zttBin"+binName[iB]+"Down");
...
if (xztt-eztt>0. && rztt>zttUnc) { zttDown->SetBinContent(iB,xztt-eztt);zttDown->SetBinError(iB,sqrt(zttDown->GetBinContent(iB)));}
    ...
    zttUp->Write("ztt_BDTmutau_stau100_LSP1My_17_zttBin_mt"+binName[iB]+"Up");
    zttDown->Write("ztt_BDTmutau_stau100_LSP1My_17_zttBin_mt"+binName[iB]+"Down");


    TH1D * dibUp = (TH1D*)dib->Clone("dib_BDTmutau_stau100_LSP1My_17_dibBin_mt"+binName[iB]+"Up");
    TH1D * dibDown = (TH1D*)dib->Clone("dib_BDTmutau_stau100_LSP1My_17_dibBin_mt"+binName[iB]+"Down");
...
if (xdib-edib>0. && rdib>dibUnc) { dibDown->SetBinContent(iB,xdib-edib);dibDown->SetBinError(iB,sqrt(dibDown->GetBinContent(iB)));}
    ...
    dibUp->Write("dib_BDTmutau_stau100_LSP1My_17_dibBin_mt"+binName[iB]+"Up");
    dibDown->Write("dib_BDTmutau_stau100_LSP1My_17_dibBin_mt"+binName[iB]+"Down");


    TH1D * wwUp = (TH1D*)ww->Clone("ww_BDTmutau_stau100_LSP1My_17_wwBin_mt"+binName[iB]+"Up");
    TH1D * wwDown = (TH1D*)ww->Clone("ww_BDTmutau_stau100_LSP1My_17_wwBin_mt"+binName[iB]+"Down");
...
if (xww-eww>0. && rww>wwUnc) { wwDown->SetBinContent(iB,xww-eww);wwDown->SetBinError(iB,sqrt(wwDown->GetBinContent(iB)));}
    ...
    wwUp->Write("ww_BDTmutau_stau100_LSP1My_17_wwBin_mt"+binName[iB]+"Up");
    wwDown->Write("ww_BDTmutau_stau100_LSP1My_17_wwBin_mt"+binName[iB]+"Down");



    TH1D * sTUp = (TH1D*)sT->Clone("sT_BDTmutau_stau100_LSP1My_17_sTBin"+binName[iB]+"Up");
    TH1D * sTDown = (TH1D*)sT->Clone("sT_BDTmutau_stau100_LSP1My_17_sTBin"+binName[iB]+"Down");
...
if (xsT-esT>0. && rsT>sTUnc) { sTDown->SetBinContent(iB,xsT-esT);sTDown->SetBinError(iB,sqrt(sTDown->GetBinContent(iB)));}
    ...
    sTUp->Write("sT_BDTmutau_stau100_LSP1My_17_sTBin_mt"+binName[iB]+"Up");
    sTDown->Write("sT_BDTmutau_stau100_LSP1My_17_sTBin_mt"+binName[iB]+"Down");


    TH1D * ttxUp = (TH1D*)ttx->Clone("ttx_BDTmutau_stau100_LSP1My_17_ttxBin"+binName[iB]+"Up");
    TH1D * ttxDown = (TH1D*)ttx->Clone("ttx_BDTmutau_stau100_LSP1My_17_ttxBin"+binName[iB]+"Down");
...
if (xttx-ettx>0. && rttx>ttxUnc) { ttxDown->SetBinContent(iB,xttx-ettx);ttxDown->SetBinError(iB,sqrt(ttxDown->GetBinContent(iB)));}
    ...
    ttxUp->Write("ttx_BDTmutau_stau100_LSP1My_17_ttxBin_mt"+binName[iB]+"Up");
    ttxDown->Write("ttx_BDTmutau_stau100_LSP1My_17_ttxBin_mt"+binName[iB]+"Down");



    TH1D * fakesUp = (TH1D*)fakes->Clone("fakes_BDTmutau_stau100_LSP1My_17_fakesBin"+binName[iB]+"Up");
    TH1D * fakesDown = (TH1D*)fakes->Clone("fakes_BDTmutau_stau100_LSP1My_17_fakesBin"+binName[iB]+"Down");
...
if (xfakes-efakes>0. && rfakes>fakesUnc) { fakesDown->SetBinContent(iB,xfakes-efakes);fakesDown->SetBinError(iB,sqrt(fakesDown->GetBinContent(iB)));}
    ...
    fakesUp->Write("fakes_BDTmutau_stau100_LSP1My_17_fakesBin_mt"+binName[iB]+"Up");
    fakesDown->Write("fakes_BDTmutau_stau100_LSP1My_17_fakesBin_mt"+binName[iB]+"Down");

    TH1D * restUp = (TH1D*)rest->Clone("rest_BDTmutau_stau100_LSP1My_17_restBin"+binName[iB]+"Up");
    TH1D * restDown = (TH1D*)rest->Clone("rest_BDTmutau_stau100_LSP1My_17_restBin"+binName[iB]+"Down");
...
if (xrest-erest>0. && rrest>restUnc) { restDown->SetBinContent(iB,xrest-erest);restDown->SetBinError(iB,sqrt(restDown->GetBinContent(iB)));}
    ...
    restUp->Write("rest_BDTmutau_stau100_LSP1My_17_restBin_mt"+binName[iB]+"Up");
    restDown->Write("rest_BDTmutau_stau100_LSP1My_17_restBin_mt"+binName[iB]+"Down");
/*
...
*/
 ...
 TString sys = Systematics[j].c_str();
  ...
  TFile *filesyst = TFile::Open ("Var_BDTmutau_stau100_LSP1My_17_35invfb_mt_Syst_"+sys+".root", "read");

 TH1D *tt_syst,* wj_syst, * dyj_syst, * ztt_syst, * dib_syst, * ww_syst, * sT_syst,* ttx_syst,* fakes_syst,*rest_syst;

if (bFirst){

   tt_syst = (TH1D*)filesyst->Get("tt_BDTmutau_stau100_LSP1My_17_"+sys);
   wj_syst = (TH1D*)filesyst->Get("wj_BDTmutau_stau100_LSP1My_17_"+sys);
   dyj_syst = (TH1D*)filesyst->Get("dyj_BDTmutau_stau100_LSP1My_17_"+sys);
   ztt_syst = (TH1D*)filesyst->Get("ztt_BDTmutau_stau100_LSP1My_17_"+sys);
   dib_syst = (TH1D*)filesyst->Get("dib_BDTmutau_stau100_LSP1My_17_"+sys);
   ww_syst = (TH1D*)filesyst->Get("ww_BDTmutau_stau100_LSP1My_17_"+sys);
   sT_syst = (TH1D*)filesyst->Get("sT_BDTmutau_stau100_LSP1My_17_"+sys);
   ttx_syst = (TH1D*)filesyst->Get("ttx_BDTmutau_stau100_LSP1My_17_"+sys);
   fakes_syst = (TH1D*)filesyst->Get("fakes_BDTmutau_stau100_LSP1My_17_"+sys);
   rest_syst = (TH1D*)filesyst->Get("rest_BDTmutau_stau100_LSP1My_17_"+sys);
...
if (sys=="BTagUp") {
		...
		wj_syst->SetName("wj_BDTmutau_stau100_LSP1My_17_misBTagUp");
		dib_syst->SetName("dib_BDTmutau_stau100_LSP1My_17_misBTagUp");
		ww_syst->SetName("ww_BDTmutau_stau100_LSP1My_17_misBTagUp");
		ztt_syst->SetName("ztt_BDTmutau_stau100_LSP1My_17_misBTagUp");
		dyj_syst->SetName("dyj_BDTmutau_stau100_LSP1My_17_misBTagUp");

}

if (sys=="BTagDown") {
	
		wj_syst->SetName("wj_BDTmutau_stau100_LSP1My_17_misBTagDown");
		dib_syst->SetName("dib_BDTmutau_stau100_LSP1My_17_misBTagDown");
		ww_syst->SetName("ww_BDTmutau_stau100_LSP1My_17_misBTagDown");
		ztt_syst->SetName("ztt_BDTmutau_stau100_LSP1My_17_misBTagDown");
		dyj_syst->SetName("dyj_BDTmutau_stau100_LSP1My_17_misBTagDown");
  ...
  TString Sname="stau-stau_left_90_LSP10_B_BDTmutau_stau100_LSP1My_17_"+sys;
  if (sys =="TopPtUp" || sys =="TopPtDown" || sys =="ZPtUp" || sys =="ZPtDown" || sys =="METRecoilUp" || sys =="METRecoilDown") Sname="stau-stau_left_90_LSP10_Nominal_B_BDTmutau_stau100_LSP1My_17_"+sys;
...
if (sys=="METUp") signal_syst->SetName("stau-stau_left_90_LSP10_B_BDTmutau_stau100_LSP1My_17_METsignalUp");
if (sys=="METDown") signal_syst->SetName("stau-stau_left_90_LSP10_B_BDTmutau_stau100_LSP1My_17_METsignalDown");
if (sys=="BTagUp")  signal_syst->SetName("stau-stau_left_90_LSP10_B_BDTmutau_stau100_LSP1My_17_misBTagUp");
if (sys=="BTagDown") signal_syst->SetName("stau-stau_left_90_LSP10_B_BDTmutau_stau100_LSP1My_17_misBTagDown");
  ...
  for (int iB=1; iB<=nBins; ++iB) {
    TH1D * signalUp = (TH1D*)signal->Clone("stau-stau_left_90_LSP10_B_BDTmutau_stau100_LSP1My_17_signalBin"+binName[iB]+"Up");
    TH1D * signalDown = (TH1D*)signal->Clone("stau-stau_left_90_LSP10_B_BDTmutau_stau100_LSP1My_17_signalBin"+binName[iB]+"Down");
...
//if (bFirst){
    signalUp->Write("stau-stau_left_90_LSP10_B_BDTmutau_stau100_LSP1My_17_signalBin_mt"+binName[iB]+"Up");
    signalDown->Write("stau-stau_left_90_LSP10_B_BDTmutau_stau100_LSP1My_17_signalBin_mt"+binName[iB]+"Down");
//	}
  }
...
//cout<<" ========================= "<<metU<<"  "<<metD<<"   "<<btagU<<"  "<<btagD<<"  "<<fabs(Syst_SofWUp-Nom_SofW)<<"  "<<fabs(Syst_SofWDown-Nom_SofW)<<"  "<<Syst_SofWUp<<"  "<<Syst_SofWDown<<"  "<<Nom_SofW<<endl;
  ...
  std::ofstream textFile("Syst/cards_mt/stau-stau_left_90_LSP10_BDTmutau_stau100_LSP1My_17_mt_35invfb.txt");
...
//  textFile << "observation " << data_obs->Integral() << std::endl;
  textFile << "-----------------" << std::endl;
  textFile << "shapes * *  Var_BDTmutau_stau100_LSP1My_17_35invfb_mt_Syst_out.root  $PROCESS    $PROCESS_$SYSTEMATIC " << std::endl;
  textFile << "-----------------" << std::endl;
  textFile << "bin                  mt	mt	mt	mt	mt mt mt mt" << std::endl;
//  textFile << "process              stau-stau_left_90_LSP10_B_BDTmutau_stau100_LSP1My_17 tt_BDTmutau_stau100_LSP1My_17 wj_BDTmutau_stau100_LSP1My_17 dyj_BDTmutau_stau100_LSP1My_17 ztt_BDTmutau_stau100_LSP1My_17 ttx_BDTmutau_stau100_LSP1My_17 dib_BDTmutau_stau100_LSP1My_17 ww_BDTmutau_stau100_LSP1My_17 sT_BDTmutau_stau100_LSP1My_17 fakes_BDTmutau_stau100_LSP1My_17" << std::endl;

  textFile << "process              stau-stau_left_90_LSP10_B_BDTmutau_stau100_LSP1My_17 tt_BDTmutau_stau100_LSP1My_17 rest_BDTmutau_stau100_LSP1My_17 dyj_BDTmutau_stau100_LSP1My_17 ztt_BDTmutau_stau100_LSP1My_17 ww_BDTmutau_stau100_LSP1My_17 sT_BDTmutau_stau100_LSP1My_17  fakes_BDTmutau_stau100_LSP1My_17" << std::endl;
