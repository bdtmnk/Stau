#include <math.h>
#include <iostream>
void CreateDatacards_BDTmutau_stau200_LSP1My_15__35() {
...
bool bFirst = false;
  ...
  //TFile * file = new TFile("Var_BDTmutau_stau200_LSP1My_15_35invfb_mt_SR");
  TFile *file = TFile::Open ("Var_BDTmutau_stau200_LSP1My_15_35invfb_mt_SR.root", "read");
  TFile *fileout = TFile::Open ("Var_BDTmutau_stau200_LSP1My_15_35invfb_mt_SR_out.root", "update");
  //file->cd("");
...
if (xtt-ett>0. && rtt>ttUnc) { ttDown->SetBinContent(iB,xtt-ett);ttDown->SetBinError(iB,sqrt(ttDown->GetBinContent(iB)));}
    ...
    ttUp->Write("tt_BDTmutau_stau200_LSP1My_15_ttBin_"+binName[iB]+"Up");
    ttDown->Write("tt_BDTmutau_stau200_LSP1My_15_ttBin_"+binName[iB]+"Down");
...
if (xwj-ewj>0. && rwj>wjUnc) { WDown->SetBinContent(iB,xwj-ewj);WDown->SetBinError(iB,sqrt(WDown->GetBinContent(iB)));}
    ...
    WUp->Write("wj_BDTmutau_stau200_LSP1My_15_wjBin_"+binName[iB]+"Up");
    WDown->Write("wj_BDTmutau_stau200_LSP1My_15_wjBin_"+binName[iB]+"Down");
...
if (xdyj-edyj>0. && rdyj>dyjUnc) { dyjDown->SetBinContent(iB,xdyj-edyj);dyjDown->SetBinError(iB,sqrt(dyjDown->GetBinContent(iB)));}
    ...
    dyjUp->Write("dyj_BDTmutau_stau200_LSP1My_15_dyjBin_"+binName[iB]+"Up");
    dyjDown->Write("dyj_BDTmutau_stau200_LSP1My_15_dyjBin_"+binName[iB]+"Down");
...
if (xztt-eztt>0. && rztt>zttUnc) { zttDown->SetBinContent(iB,xztt-eztt);zttDown->SetBinError(iB,sqrt(zttDown->GetBinContent(iB)));}
    ...
    zttUp->Write("ztt_BDTmutau_stau200_LSP1My_15_zttBin_"+binName[iB]+"Up");
    zttDown->Write("ztt_BDTmutau_stau200_LSP1My_15_zttBin_"+binName[iB]+"Down");


    TH1D * dibUp = (TH1D*)dib->Clone("dib_BDTmutau_stau200_LSP1My_15_dibBin_"+binName[iB]+"Up");
    TH1D * dibDown = (TH1D*)dib->Clone("dib_BDTmutau_stau200_LSP1My_15_dibBin_"+binName[iB]+"Down");
...
if (xdib-edib>0. && rdib>dibUnc) { dibDown->SetBinContent(iB,xdib-edib);dibDown->SetBinError(iB,sqrt(dibDown->GetBinContent(iB)));}
    ...
    dibUp->Write("dib_BDTmutau_stau200_LSP1My_15_dibBin_"+binName[iB]+"Up");
    dibDown->Write("dib_BDTmutau_stau200_LSP1My_15_dibBin_"+binName[iB]+"Down");


    TH1D * wwUp = (TH1D*)ww->Clone("ww_BDTmutau_stau200_LSP1My_15_wwBin_"+binName[iB]+"Up");
    TH1D * wwDown = (TH1D*)ww->Clone("ww_BDTmutau_stau200_LSP1My_15_wwBin_"+binName[iB]+"Down");
...
if (xww-eww>0. && rww>wwUnc) { wwDown->SetBinContent(iB,xww-eww);wwDown->SetBinError(iB,sqrt(wwDown->GetBinContent(iB)));}
    ...
    wwUp->Write("ww_BDTmutau_stau200_LSP1My_15_wwBin_"+binName[iB]+"Up");
    wwDown->Write("ww_BDTmutau_stau200_LSP1My_15_wwBin_"+binName[iB]+"Down");
...
if (xsT-esT>0. && rsT>sTUnc) { sTDown->SetBinContent(iB,xsT-esT);sTDown->SetBinError(iB,sqrt(sTDown->GetBinContent(iB)));}
    ...
    sTUp->Write("sT_BDTmutau_stau200_LSP1My_15_sTBin_"+binName[iB]+"Up");
    sTDown->Write("sT_BDTmutau_stau200_LSP1My_15_sTBin_"+binName[iB]+"Down");
...
if (xttx-ettx>0. && rttx>ttxUnc) { ttxDown->SetBinContent(iB,xttx-ettx);ttxDown->SetBinError(iB,sqrt(ttxDown->GetBinContent(iB)));}
    ...
    ttxUp->Write("ttx_BDTmutau_stau200_LSP1My_15_ttxBin_"+binName[iB]+"Up");
    ttxDown->Write("ttx_BDTmutau_stau200_LSP1My_15_ttxBin_"+binName[iB]+"Down");
...
if (xfakes-efakes>0. && rfakes>fakesUnc) { fakesDown->SetBinContent(iB,xfakes-efakes);fakesDown->SetBinError(iB,sqrt(fakesDown->GetBinContent(iB)));}
    ...
    fakesUp->Write("fakes_BDTmutau_stau200_LSP1My_15_fakesBin_"+binName[iB]+"Up");
    fakesDown->Write("fakes_BDTmutau_stau200_LSP1My_15_fakesBin_"+binName[iB]+"Down");
...
if (xrest-erest>0. && rrest>restUnc) { restDown->SetBinContent(iB,xrest-erest);restDown->SetBinError(iB,sqrt(restDown->GetBinContent(iB)));}
    ...
    restUp->Write("rest_BDTmutau_stau200_LSP1My_15_restBin_"+binName[iB]+"Up");
    restDown->Write("rest_BDTmutau_stau200_LSP1My_15_restBin_"+binName[iB]+"Down");
/*
...
*/
 ...
 TString sys = Systematics[j].c_str();
  ...
  TFile *filesyst = TFile::Open ("Var_BDTmutau_stau200_LSP1My_15_35invfb_mt_SR_"+sys+".root", "read");
...
//if (bFirst){
    signalUp->Write("stau-stau_left_90_LSP10_B_BDTmutau_stau200_LSP1My_15_signalBin_"+binName[iB]+"Up");
    signalDown->Write("stau-stau_left_90_LSP10_B_BDTmutau_stau200_LSP1My_15_signalBin_"+binName[iB]+"Down");
//	}
  }
...
//cout<<" ========================= "<<metU<<"  "<<metD<<"   "<<btagU<<"  "<<btagD<<"  "<<fabs(Syst_SofWUp-Nom_SofW)<<"  "<<fabs(Syst_SofWDown-Nom_SofW)<<"  "<<Syst_SofWUp<<"  "<<Syst_SofWDown<<"  "<<Nom_SofW<<endl;
  ...
  std::ofstream textFile("SR/cards_/stau-stau_left_90_LSP10_BDTmutau_stau200_LSP1My_15__35invfb.txt");
...
//  textFile << "observation " << data_obs->Integral() << std::endl;
  textFile << "-----------------" << std::endl;
  textFile << "shapes * *  Var_BDTmutau_stau200_LSP1My_15_35invfb_mt_SR_out.root  $PROCESS    $PROCESS_$SYSTEMATIC " << std::endl;
  textFile << "-----------------" << std::endl;
