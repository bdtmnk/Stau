...
void OverlapVarsCRdegen(string syst="Nominal", string reg="SR")
{
...
cout<<" Ratio "<<allnew_->GetSumOfWeights()<<" Data "<<variable<<" data "<<hh[1]->GetSumOfWeights()<<" tt "<<
					htt->GetSumOfWeights()/allnew_->GetSumOfWeights()<<" dy "<<(hdyj->GetSumOfWeights()+hztt->GetSumOfWeights())/allnew_->GetSumOfWeights()<<" wj "<<hwj->GetSumOfWeights()/allnew_->GetSumOfWeights()<<" stop "<<hstop->GetSumOfWeights()/allnew_->GetSumOfWeights()<<
					" vv"<<(hdib->GetSumOfWeights()+hww->GetSumOfWeights())/allnew_->GetSumOfWeights()<<" fakes "<<hfakes->GetSumOfWeights()/allnew_->GetSumOfWeights()<<" rest "<<(hrest->GetSumOfWeights()+httx->GetSumOfWeights())/allnew_->GetSumOfWeights()<<endl;
