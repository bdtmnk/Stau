...
//	variables.push_back("BDTmutau_stau100_LSP50My_15"); 
	variables.push_back("BDTmutau_stau100_LSP1My_15"); 
//	variables.push_back("BDTmutau_stau150_LSP100My_15"); 
	variables.push_back("BDTmutau_stau150_LSP1My_15"); 
...
//	variables.push_back("BDTmutau_stau200_LSP150My_15"); 
	variables.push_back("BDTmutau_stau200_LSP1My_15"); 
//	variables.push_back("BDTmutau_stau200_LSP50My_15"); 
	variables.push_back("BDTmutau_stau300_LSP1My_15");
	/*
...
*/				
				...
				htt->SetAxisRange(0.1,0.5);
				hwj->SetAxisRange(0.1,0.5);
				hdyj->SetAxisRange(0.1,0.5);
				hztt->SetAxisRange(0.1,0.5);
				hstop->SetAxisRange(0.1,0.5);
				hdib->SetAxisRange(0.1,0.5);
				hww->SetAxisRange(0.1,0.5);
				hfakes->SetAxisRange(0.1,0.5);
				httx->SetAxisRange(0.1,0.5);
				hrest->SetAxisRange(0.1,0.5);
				hfakes->SetAxisRange(0.1,0.5);
				hh[1]->SetAxisRange(0.1,0.5);
				...
				htt->SetAxisRange(-0.5,0.1);
				hwj->SetAxisRange(-0.5,0.1);
				hdyj->SetAxisRange(-0.5,0.1);
				hztt->SetAxisRange(-0.5,0.1);
				hstop->SetAxisRange(-0.5,0.1);
				hdib->SetAxisRange(-0.5,0.1);
				hww->SetAxisRange(-0.5,0.1);
				hfakes->SetAxisRange(-0.5,0.1);
				httx->SetAxisRange(-0.5,0.1);
				hrest->SetAxisRange(-0.5,0.1);
				hfakes->SetAxisRange(-0.5,0.1);
				hh[1]->SetAxisRange(-0.5,0.1);
...
if (region == "SR")
				...
				htest_signal->SetAxisRange(0.1,0.5);
				...
				htest_signal->SetAxisRange(-0.5,0.1);
