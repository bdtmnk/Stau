...
//		if ( string::npos == nn.find("CutFlowUnW")) flcont=false;
		...
		//if (string::npos == nn.find("l") ||  string::npos == nn.find("_16")) flcont=false;
		//if (string::npos != nn.find("Delta") ) continue;
		if (string::npos == nn.find("TaupT_14")) flcont=false;


//                if (string::npos == nn.find("_9") && string::npos == nn.find("_13"))  flcont=false;
		if (!flcont) continue;
		...
		if (obj->IsA ()->InheritsFrom ("TH1D") ) {
			...
			string fname= nextsource->GetName();
				  ...
				  if ( std::string::npos != fname.find("TT_TuneCUETP8M2T4_13TeV-powheg-pythia8") ) eventCountt = (TH1D*)nextsource->Get(Channel+"/histTopPt");
					...
					if (std::string::npos != fname.find("DYJetsToLL_M-50_13TeV-madgraphMLM-pythia8_1Parton") || std::string::npos != fname.find("DYJetsToLL_M-50_13TeV-madgraphMLM-pythia8_isZTT_1Parton") || std::string::npos != fname.find("DY1JetsToLL_M-50_13TeV-madgraphMLM-pythia8"))
					...
					if (std::string::npos != fname.find("DYJetsToLL_M-50_13TeV-madgraphMLM-pythia8_2Parton") || std::string::npos != fname.find("DYJetsToLL_M-50_13TeV-madgraphMLM-pythia8_isZTT_2Parton") || std::string::npos != fname.find("DY2JetsToLL_M-50_13TeV-madgraphMLM-pythia8"))
						normm = 1.428*Lumi/ ( DYInclw->GetSumOfWeights()/float(5765.4*0.9611) + float(DY2Jw->GetSumOfWeights())/float(1.1637*332.8*0.9611));

					if (std::string::npos != fname.find("DYJetsToLL_M-50_13TeV-madgraphMLM-pythia8_3Parton") || std::string::npos != fname.find("DYJetsToLL_M-50_13TeV-madgraphMLM-pythia8_isZTT_3Parton") || std::string::npos != fname.find("DY3JetsToLL_M-50_13TeV-madgraphMLM-pythia8"))
						normm = 1.428*Lumi/ ( DYInclw->GetSumOfWeights()/float(5765.4*0.9611) + float(DY3Jw->GetSumOfWeights())/float(1.1637*101.8*0.9611));

					if (std::string::npos != fname.find("DYJetsToLL_M-50_13TeV-madgraphMLM-pythia8_4Parton") || std::string::npos != fname.find("DYJetsToLL_M-50_13TeV-madgraphMLM-pythia8_isZTT_4Parton") || std::string::npos != fname.find("DY4JetsToLL_M-50_13TeV-madgraphMLM-pythia8"))
	...
	/////////////SinglTop
		...
		if (obj->IsA ()->InheritsFrom ("TH1")) {
			...
			//pie3->Draw("3d");
			nan_.erase(0,4);
			sprintf(savename,"TauWDD/Pie_mutau.root",nan_);
			cpie->Print(savename,".root");
...
{			//if (std::string::npos != nn.find("BDTmutau_")) hh[1]->GetXaxis()->SetRange(0,23);
...
if (SO_){
		...
		//	allbkg->Sumw2();
			for (int iB=1; iB<=hsum->GetNbinsX(); ++iB) {
				...
				//if (std::string::npos != nn.find("BDTmutau_") && iB>23) {datE = 0;bkgErr=0;ratio->SetBinContent(iB,0);}
...
hww->GetSumOfWeights()<<"  htt  "<< htt->GetSumOfWeights()<<"  hstop  "<<hstop->GetSumOfWeights()<<"  hdyj  "<<
  hdyj->GetSumOfWeights()<<"  hztt  "<<hztt->GetSumOfWeights()<<"  data  "<<hh[1]->GetSumOfWeights()<<endl;
                ...
                cout << "  hdib  "<< hdib->Integral(7,11)<<"  httx  "<< httx->Integral(7,11)<<"  hwj  "<< hwj->Integral(7,11)<<
"  hqcd  "<<hqcd->Integral(7,11)<<"  hww  "<<
hww->Integral(7,11)<<"  htt  "<< htt->Integral(7,11)<<"  hstop  "<<hstop->Integral(7,11)<<"  hdyj  "<<
  hdyj->Integral(7,11)<<"  hztt  "<<hztt->Integral(7,11)<<"  data  "<<hh[1]->Integral(7,11)<<endl;
...
//			if (std::string::npos != title1.find("MCTb"))  h->GetXaxis()->SetTitle("M_{CTb} [GeV]");
			...
			if (std::string::npos != title1.find("BDTmutau_stau100_LSP1"))  {h->GetXaxis()->SetTitle("BDT (100,1)");}
			if (std::string::npos != title1.find("BDTmutau_stau150_LSP1"))  h->GetXaxis()->SetTitle("BDT (150,1)");
			if (std::string::npos != title1.find("BDTmutau_stau200_LSP1"))  h->GetXaxis()->SetTitle("BDT (200,1)");
			if (std::string::npos != title1.find("BDTmutau_stau300_LSP1"))  h->GetXaxis()->SetTitle("BDT (300,1)");
			if (std::string::npos != title1.find("DNNmutau_Stau100"))  h->GetXaxis()->SetTitle("DNN (100,1)");
