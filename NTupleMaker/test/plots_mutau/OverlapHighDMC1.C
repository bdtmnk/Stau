...
void OverlapHighDMC1()
{
	...
	string fout = "mergedplotsTauHighDMC1.root";
	...
	//	c1 = example_plot(3, 0 , obj->GetName ());
		...
		if (obj) {
			...
			if (cl=1){
				...
				legend_c1->AddEntry(hsignal[0], "C1C1(150,50)", "LEP");
				legend_c1->AddEntry(hsignal[1], "C1C1(200,100)", "LEP");
				legend_c1->AddEntry(hsignal[2], "C1C1(250,150)", "LEP");
				legend_c1->AddEntry(hsignal[3], "C1C1(300,200)", "LEP");
				legend_c1->AddEntry(hsignal[4], "C1C1(350,250)", "LEP");
				legend_c1->AddEntry(hsignal[5], "C1C1(400,200)", "LEP");
				legend_c1->AddEntry(hsignal[6], "C1N2(150,50)", "LEP");
				legend_c1->AddEntry(hsignal[7], "C1N2(200,100)", "LEP");
				legend_c1->AddEntry(hsignal[8], "C1N2(250,150)", "LEP");
				legend_c1->AddEntry(hsignal[9], "C1N2(300,200)", "LEP");
				legend_c1->AddEntry(hsignal[10], "C1N2(350,250)", "LEP");
				legend_c1->AddEntry(hsignal[11], "C1N2(400,200)", "LEP");
			...
			*/
			...
			if (!norm_)sprintf(f,"TauHighDMC1/%s.pdf",namee);
			else sprintf(f,"TauHighDMC1/%s_Norm.pdf",namee);

			if (!norm_)sprintf(ff,"TauHighDMC1/%s_Log.pdf",namee);
			else sprintf(ff,"TauHighDMC1/%s_Log_Norm.pdf",namee);
			...
			pie3->Draw("rsc");
			//pie3->Draw("3d");
			cpie->SaveAs("TauHighDMC1/APie.pdf");
