...
void OverlapTF(string syst="Nominal")
{
	...
	string np_title = titles[0];
				...
				if (s_!="Nominal") app_="_"+s_;
					...
					WInclname = "WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8"+app_+"_Nominal_D.root";
					W1Jname = "W1JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8"+app_+"_Nominal_D.root";
					W2Jname = "W2JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8"+app_+"_Nominal_D.root";
					W3Jname = "W3JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8"+app_+"_Nominal_D.root";
					W4Jname = "W4JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8"+app_+"_Nominal_D.root";

					DYInclname = "DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8"+app_+"_Nominal_D.root";
					DY1Jname = "DY1JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8"+app_+"_Nominal_D.root";
					DY2Jname = "DY2JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8"+app_+"_Nominal_D.root";
					DY3Jname = "DY3JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8"+app_+"_Nominal_D.root";
					DY4Jname = "DY4JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8"+app_+"_Nominal_D.root";
...
Impose (TDirectory * target, TList * sourcelist, string & np_title_, vector<string> titles,vector<float> xsecs, string syst)
{
	...
	while ((key = (TKey *) nextkey ())) {
		...
		//if ( string::npos == nn.find("nJet")  && (string::npos == nn.find("CutFlow"))) continue;
 		...
 		if (string::npos == nn.find("TauPtEta15")) continue;
...
cout <<fname<<"   "<<h2->GetSumOfWeights()  <<endl;
					...
					if ((int)cl>2 && h2->GetSumOfWeights()>0.)  {
						...
						if (std::string::npos != fname.find("_C.root") ) {
							allRegC->Add(h2,-1);
							allbkgC->Add(h2,1);
							cout <<fname << "   "<< allRegC->GetSumOfWeights() <<endl;
							}
						...
						if (std::string::npos != fname.find("_D.root") ) {
							...
							allRegD->Add(h2,-1);
							allbkgD->Add(h2,1);
							cout <<fname << "   "<< allRegD->GetSumOfWeights() <<endl;
        ...
        fout<<" {" <<endl;
        fout<<"        if (pt>20 && pt<30) SF = "<<ratio->GetBinContent(1,1)<<";" <<endl;
        fout<<"         if (pt>30 && pt<40) SF = "<<ratio->GetBinContent(2,1)<<";" <<endl;
        //fout<<"         if (pt>40 ) SF = "<<ratio->GetBinContent(3,1)<<";" <<endl;
        fout<<" }" <<endl;
		fout<<" if (  fabs(eta) > 0.8 && fabs(eta) < 1.44 )" <<endl;
        fout<<" {" <<endl;

        fout<<"        if (pt>20 && pt<30) SF = "<<ratio->GetBinContent(1,2)<<";" <<endl;
        fout<<"         if (pt>30 && pt<40) SF = "<<ratio->GetBinContent(2,2)<<";" <<endl;
        //fout<<"         if (pt>40 ) SF = "<<ratio->GetBinContent(3,2)<<";" <<endl;
        fout<<" }" <<endl;
...
cout << errorD<<endl;
		...
		ratio->SetBinError(1,3, ratio->GetBinContent(1,3)*sqrt(errorC*errorC+errorD*errorD));
        fout<<"        if (pt>20) SF = "<<ratio->GetBinContent(1,3)<<";" <<endl;
        //fout<<"         if (pt>30 && pt<40) SF = "<<ratio->GetBinContent(2,3)<<";" <<endl;
        //fout<<"         if (pt>40 ) SF = "<<ratio->GetBinContent(3,3)<<";" <<endl;
        fout<<" }" <<endl;
		fout<<" if (  fabs(eta) > 1.566 && fabs(eta) < 2.3 )" <<endl;
        fout<<" {" <<endl;

        fout<<"        if (pt>20 && pt<30) SF = "<<ratio->GetBinContent(1,4)<<";" <<endl;
        fout<<"         if (pt>30 && pt<40) SF = "<<ratio->GetBinContent(2,4)<<";" <<endl;
        //fout<<"         if (pt>40 ) SF = "<<ratio->GetBinContent(3,4)<<";" <<endl;
        fout<<" }" <<endl;
        ...
        fout<<"         if (pt>70) SF = "<<ratio->GetBinContent(4,1)<<";" <<endl;
        ...
        cout<<"        if (pt>20 && pt<30) SF = "<<ratio->GetBinError(1,1)<<";" <<endl;
        cout<<"         if (pt>30 && pt<40) SF = "<<ratio->GetBinError(2,1)<<";" <<endl;
        cout<<"         if (pt>40 ) SF = "<<ratio->GetBinError(3,1)<<";" <<endl;
		cout<<" if (  fabs(eta) > 0.8 && fabs(eta) < 1.44 )" <<endl;

        cout<<"        if (pt>20 && pt<30) SF = "<<ratio->GetBinError(1,2)<<";" <<endl;
        cout<<"         if (pt>30 && pt<40) SF = "<<ratio->GetBinError(2,2)<<";" <<endl;
        cout<<"         if (pt>40 ) SF = "<<ratio->GetBinError(3,2)<<";" <<endl;

		cout<<" if (  fabs(eta) > 1.44 && fabs(eta) < 1.566 )" <<endl;

        cout<<"        if (pt>20 && pt<30) SF = "<<ratio->GetBinError(1,3)<<";" <<endl;
        cout<<"         if (pt>30 && pt<40) SF = "<<ratio->GetBinError(2,3)<<";" <<endl;
        cout<<"         if (pt>40 ) SF = "<<ratio->GetBinError(3,3)<<";" <<endl;
		cout<<" if (  fabs(eta) > 1.566 && fabs(eta) < 2.3 )" <<endl;
        cout<<"        if (pt>20 && pt<30) SF = "<<ratio->GetBinError(1,4)<<";" <<endl;
        cout<<"         if (pt>30 && pt<40) SF = "<<ratio->GetBinError(2,4)<<";" <<endl;
        cout<<"         if (pt>40 ) SF = "<<ratio->GetBinError(3,4)<<";" <<endl;
