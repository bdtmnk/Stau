...
_lt=`echo $line | cut -d '/' -f2`
	...
	do
		...
		echo python /nfs/dust/cms/user/dydukhle/STAU/Analysis18/CMSSW_10_2_16/src/DesyTauAnalyses/NTupleMaker/test/FAKES_Estimation/run_plots_newDataDriven_new_MuTau_A.py list_$_lt $2 $syst >> job_MuTau_${channel}_${_lt}_$syst
