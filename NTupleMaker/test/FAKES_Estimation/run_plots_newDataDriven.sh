...
cd /nfs/dust/cms/user/dydukhle/STAU/Analysis18/CMSSW_10_2_16/src/DesyTauAnalyses/NTupleMaker/test;eval `scramv1 runtime -sh` ;
...
rm -rf dir_${file}_${channel}_$syst
...
echo ==========       Do something is systematic is the TopPt or ZPt Up/Down
...
rm analyzer.h analyzer.C analyzer_h analyzermutau_C plots.h
cp $dir/b_analyzer_h $dir/analyzer_h

cp $dir/b_analyzermutau_C $dir/analyzermutau_C
...
rm analyzer.h analyzer.C analyzer_h analyzermutau_C plots.h
cp -f  $dir/b_analyzer_h $dir/analyzer_h
cp -f $dir/b_analyzermutau_C $dir/analyzermutau_C
cp -f $dir/analyzer_h analyzer.h
cp -f $dir/analyzer${channel}_C analyzer.C
cp $dir/runme.C .
cp $dir/b_plots.h plots.h
...
cd ${dir}
echo _dir_${file}_${channel}_$syst
rm -fr _dir_${file}_${channel}_$syst
