...
os.system("cd /nfs/dust/cms/user/dydukhle/STAU/Analysis18/CMSSW_10_2_16/src/DesyTauAnalyses/NTupleMaker/test/FAKES_Estimation/")
#/nfs/dust/cms/user/dydukhle/CMSSW_9_4_0_patch1/src/DesyTauAnalyses/NTupleMaker/test")#;eval `scramv1 runtime -sh` ;
dir="/nfs/dust/cms/user/dydukhle/STAU/Analysis18/CMSSW_10_2_16/src/DesyTauAnalyses/NTupleMaker/test/FAKES_Estimation/"
i=0
print(arguments)
...
for i in range(len(content)):
    ...
    if os.path.exists("./plots_MuTau/{0}_B.root".format(fileB)):continue
    ...
    os.system("mv {0}/{3}/plots.root {0}/plots_MuTau/{2}_B.root".format(dir, channel, fileB, working_dir))
