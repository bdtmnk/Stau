...
const int mycolordyj=TColor::GetColor("#ffcc66");
const int mycolorztt=TColor::GetColor("#58d885");
const int mycolorst=TColor::GetColor("#b6d0ea");
...
TH1D* WInclw,*W1Jw,*W2Jw,*W3Jw,*W4Jw,*WHTzw,*WHTaw,*WHTbw,*WHTcw,*WHTdw,*WHTew,*WHTfw;
...
*/			
	...
	cout<< " the variable name  "<<variable<<" syst "<<syst<<endl;
				...
				TString WHT0To70name,WHT70To100name,WHT100To200name,WHT200To400name,WHT400To600name,WHT600To800name,WHT800To1200name;
				...
				if (syst != "Nominal") app_="";
					...
					//WHT0To70name = "WJetsToLNu_HT-0To70_13TeV-madgraphMLM-pythia8"+app_+"_B.root";
					WHT70To100name = "WJetsToLNu_HT-70To100_13TeV-madgraphMLM-pythia8"+app_+"_B.root";
					WHT100To200name = "WJetsToLNu_HT-100To200_13TeV-madgraphMLM-pythia8"+app_+"_B.root";
					WHT200To400name = "WJetsToLNu_HT-200To400_13TeV-madgraphMLM-pythia8"+app_+"_B.root";
					WHT400To600name = "WJetsToLNu_HT-400To600_13TeV-madgraphMLM-pythia8"+app_+"_B.root";
					WHT600To800name = "WJetsToLNu_HT-600To800_13TeV-madgraphMLM-pythia8"+app_+"_B.root";
					WHT800To1200name = "WJetsToLNu_HT-800To1200_13TeV-madgraphMLM-pythia8"+app_+"_B.root";
				...
				//TFile *WHT0To70f = TFile::Open (WHT0To70name, "read");
				TFile *WHT70To100f = TFile::Open (WHT70To100name, "read");
				TFile *WHT100To200f = TFile::Open (WHT100To200name, "read");
				TFile *WHT200To400f = TFile::Open (WHT200To400name, "read");
				TFile *WHT400To600f = TFile::Open (WHT400To600name, "read");
				TFile *WHT600To800f = TFile::Open (WHT600To800name, "read");
				TFile *WHT800To1200f = TFile::Open (WHT800To1200name, "read");
...
cout<<"/////////////////////////========================================///////////////////////////////"<<endl;
			//WHTzw= (TH1D*)WHT0To70f->Get(Channel+"/histWeightsH");
			WHTaw= (TH1D*)WHT70To100f->Get(Channel+"/histWeightsH");
			WHTbw= (TH1D*)WHT100To200f->Get(Channel+"/histWeightsH");
			WHTcw= (TH1D*)WHT200To400f->Get(Channel+"/histWeightsH");
			WHTdw= (TH1D*)WHT400To600f->Get(Channel+"/histWeightsH");
			WHTew= (TH1D*)WHT600To800f->Get(Channel+"/histWeightsH");
			WHTfw= (TH1D*)WHT800To1200f->Get(Channel+"/histWeightsH");

cout<<"/////////////////////////============read WHT files============================///////////////////////////////"<<endl;
		...
		if (obj->IsA ()->InheritsFrom ("TH1") ) {
			...
			string fname= nextsource->GetName();
				...
				TH1D* eventCountt ;
				  ...
				  eventCountt = (TH1D*)nextsource->Get(Channel+"/histWeightsH");
                                  if (std::string::npos != fname.find("TT_TuneCUETP8M2T4_13TeV-powheg-pythia8") && syst != "TopPtUp" && syst != "TopPtDown") eventCountt = (TH1D*)nextsource->Get(Channel+"/histTopPt");
                                  if (std::string::npos != fname.find("TT_TuneCUETP8M2T4_13TeV-powheg-pythia8") && syst == "TopPtDown" ) eventCountt = (TH1D*)nextsource->Get(Channel+"/histWeightsH");
				...
				float WJNorm=0.8853;
				  ...
				  ///////////////// 0 Parton ////////////
					/////////////////////
					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8") && std::string::npos == fname.find("_HT-") && std::string::npos == fname.find("Parton")) 
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm));

					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_0Parton")) 
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm));
			
					///////////////// 1 Parton ////////////

					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_1Parton_HT-0To70") || std::string::npos != fname.find("W1JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-0To70")) 
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W1Jw->GetSumOfWeights())/float(1.221*9644.5*WJNorm));


					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_1Parton_HT-70To100") || std::string::npos != fname.find("W1JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-70To100") || std::string::npos != fname.find("WJetsToLNu_HT-70To100_13TeV-madgraphMLM-pythia8_1Parton")) 
						
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W1Jw->GetSumOfWeights())/float(1.221*9644.5*WJNorm) + float(WHTaw->GetSumOfWeights())/float(1.221*1319*WJNorm));


					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_1Parton_HT-100To200") || std::string::npos != fname.find("W1JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-100To200") || std::string::npos != fname.find("WJetsToLNu_HT-100To200_13TeV-madgraphMLM-pythia8_1Parton")) 
						
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W1Jw->GetSumOfWeights())/float(1.221*9644.5*WJNorm) + float(WHTbw->GetSumOfWeights())/float(1.221*1345*WJNorm));

					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_1Parton_HT-200To400") || std::string::npos != fname.find("W1JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-200To400") || std::string::npos != fname.find("WJetsToLNu_HT-200To400_13TeV-madgraphMLM-pythia8_1Parton")) 
						
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W1Jw->GetSumOfWeights())/float(1.221*9644.5*WJNorm) + float(WHTcw->GetSumOfWeights())/float(1.221*359.7*WJNorm));


					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_1Parton_HT-400To600") || std::string::npos != fname.find("W1JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-400To600") || std::string::npos != fname.find("WJetsToLNu_HT-400To600_13TeV-madgraphMLM-pythia8_1Parton"))
						
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W1Jw->GetSumOfWeights())/float(1.221*9644.5*WJNorm) + float(WHTdw->GetSumOfWeights())/float(1.221*48.91*WJNorm));

					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_1Parton_HT-600To800") || std::string::npos != fname.find("W1JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-600To800") || std::string::npos != fname.find("WJetsToLNu_HT-600To800_13TeV-madgraphMLM-pythia8_1Parton"))
						
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W1Jw->GetSumOfWeights())/float(1.221*9644.5*WJNorm) + float(WHTew->GetSumOfWeights())/float(1.221*12.05*WJNorm));



					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_1Parton_HT-800To1200") || std::string::npos != fname.find("W1JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-800To1200") || std::string::npos != fname.find("WJetsToLNu_HT-800To1200_13TeV-madgraphMLM-pythia8_1Parton")) 
						
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W1Jw->GetSumOfWeights())/float(1.221*9644.5*WJNorm) + float(WHTfw->GetSumOfWeights())/float(1.221*5.501*WJNorm));


					/////////////////////
				  ///////////////// 2 Parton ////////////
					/////////////////////
					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_2Parton_HT-0To70") || std::string::npos != fname.find("W2JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-0To70"))
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W2Jw->GetSumOfWeights())/float(1.221*3144.5*WJNorm));


					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_2Parton_HT-70To100") || std::string::npos != fname.find("W2JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-70To100") || std::string::npos != fname.find("WJetsToLNu_HT-70To100_13TeV-madgraphMLM-pythia8_2Parton")) 
						
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W2Jw->GetSumOfWeights())/float(1.221*3144.5*WJNorm) + float(WHTaw->GetSumOfWeights())/float(1.221*1319*WJNorm));


					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_2Parton_HT-100To200") || std::string::npos != fname.find("W2JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-100To200") || std::string::npos != fname.find("WJetsToLNu_HT-100To200_13TeV-madgraphMLM-pythia8_2Parton")) 
						
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W2Jw->GetSumOfWeights())/float(1.221*3144.5*WJNorm) + float(WHTbw->GetSumOfWeights())/float(1.221*1345*WJNorm));

					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_2Parton_HT-200To400") || std::string::npos != fname.find("W2JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-200To400") || std::string::npos != fname.find("WJetsToLNu_HT-200To400_13TeV-madgraphMLM-pythia8_2Parton")) 
						
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W2Jw->GetSumOfWeights())/float(1.221*3144.5*WJNorm) + float(WHTcw->GetSumOfWeights())/float(1.221*359.7*WJNorm));


					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_2Parton_HT-400To600") || std::string::npos != fname.find("W2JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-400To600") || std::string::npos != fname.find("WJetsToLNu_HT-400To600_13TeV-madgraphMLM-pythia8_2Parton")) 
						
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W2Jw->GetSumOfWeights())/float(1.221*3144.5*WJNorm) + float(WHTdw->GetSumOfWeights())/float(1.221*48.91*WJNorm));

					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_2Parton_HT-600To800") || std::string::npos != fname.find("W2JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-600To800") || std::string::npos != fname.find("WJetsToLNu_HT-600To800_13TeV-madgraphMLM-pythia8_2Parton")) 
						
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W2Jw->GetSumOfWeights())/float(1.221*3144.5*WJNorm) + float(WHTew->GetSumOfWeights())/float(1.221*12.05*WJNorm));



					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_2Parton_HT-800To1200") || std::string::npos != fname.find("W2JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-800To1200") || std::string::npos != fname.find("WJetsToLNu_HT-800To1200_13TeV-madgraphMLM-pythia8_2Parton")) 
						
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W2Jw->GetSumOfWeights())/float(1.221*3144.5*WJNorm) + float(WHTfw->GetSumOfWeights())/float(1.221*5.501*WJNorm));
				  ...
				  ///////////////// 3 Parton ////////////
					/////////////////////
					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_3Parton_HT-0To70") || std::string::npos != fname.find("W3JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-0To70")) 
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W3Jw->GetSumOfWeights())/float(1.221*954.8*WJNorm));


					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_3Parton_HT-70To100") || std::string::npos != fname.find("W3JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-70To100") || std::string::npos != fname.find("WJetsToLNu_HT-70To100_13TeV-madgraphMLM-pythia8_3Parton")) 
						
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W3Jw->GetSumOfWeights())/float(1.221*954.8*WJNorm) + float(WHTaw->GetSumOfWeights())/float(1.221*1319*WJNorm));


					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_3Parton_HT-100To200") || std::string::npos != fname.find("W3JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-100To200") || std::string::npos != fname.find("WJetsToLNu_HT-100To200_13TeV-madgraphMLM-pythia8_3Parton"))
						
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W3Jw->GetSumOfWeights())/float(1.221*954.8*WJNorm) + float(WHTbw->GetSumOfWeights())/float(1.221*1345*WJNorm));

					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_3Parton_HT-200To400") || std::string::npos != fname.find("W3JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-200To400") || std::string::npos != fname.find("WJetsToLNu_HT-200To400_13TeV-madgraphMLM-pythia8_3Parton"))
						
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W3Jw->GetSumOfWeights())/float(1.221*954.8*WJNorm) + float(WHTcw->GetSumOfWeights())/float(1.221*359.7*WJNorm));


					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_3Parton_HT-400To600") || std::string::npos != fname.find("W3JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-400To600") || std::string::npos != fname.find("WJetsToLNu_HT-400To600_13TeV-madgraphMLM-pythia8_3Parton"))
						
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W3Jw->GetSumOfWeights())/float(1.221*954.8*WJNorm) + float(WHTdw->GetSumOfWeights())/float(1.221*48.91*WJNorm));

					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_3Parton_HT-600To800") || std::string::npos != fname.find("W3JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-600To800") || std::string::npos != fname.find("WJetsToLNu_HT-600To800_13TeV-madgraphMLM-pythia8_3Parton"))
						
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W3Jw->GetSumOfWeights())/float(1.221*954.8*WJNorm) + float(WHTew->GetSumOfWeights())/float(1.221*12.05*WJNorm));



					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_3Parton_HT-800To1200") || std::string::npos != fname.find("W3JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-800To1200") || std::string::npos != fname.find("WJetsToLNu_HT-800To1200_13TeV-madgraphMLM-pythia8_3Parton"))
						
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W3Jw->GetSumOfWeights())/float(1.221*954.8*WJNorm) + float(WHTfw->GetSumOfWeights())/float(1.221*5.501*WJNorm));
				  ...
				  ///////////////// 4 Parton ////////////
					/////////////////////
					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_4Parton_HT-0To70") || std::string::npos != fname.find("W4JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-0To70"))
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W4Jw->GetSumOfWeights())/float(1.221*485.6*WJNorm));


					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_4Parton_HT-70To100") || std::string::npos != fname.find("W4JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-70To100") || std::string::npos != fname.find("WJetsToLNu_HT-70To100_13TeV-madgraphMLM-pythia8_4Parton")) 
		
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W4Jw->GetSumOfWeights())/float(1.221*485.6*WJNorm) + float(WHTaw->GetSumOfWeights())/float(1.221*1319*WJNorm));


					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_4Parton_HT-100To200") || std::string::npos != fname.find("W4JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-100To200") || std::string::npos != fname.find("WJetsToLNu_HT-100To200_13TeV-madgraphMLM-pythia8_4Parton"))
						
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W4Jw->GetSumOfWeights())/float(1.221*485.6*WJNorm) + float(WHTbw->GetSumOfWeights())/float(1.221*1345*WJNorm));

					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_4Parton_HT-200To400") || std::string::npos != fname.find("W4JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-200To400") || std::string::npos != fname.find("WJetsToLNu_HT-200To400_13TeV-madgraphMLM-pythia8_4Parton"))
						
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W4Jw->GetSumOfWeights())/float(1.221*485.6*WJNorm) + float(WHTcw->GetSumOfWeights())/float(1.221*359.7*WJNorm));


					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_4Parton_HT-400To600") || std::string::npos != fname.find("W4JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-400To600") || std::string::npos != fname.find("WJetsToLNu_HT-400To600_13TeV-madgraphMLM-pythia8_4Parton"))
						
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W4Jw->GetSumOfWeights())/float(1.221*485.6*WJNorm) + float(WHTdw->GetSumOfWeights())/float(1.221*48.91*WJNorm));

					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_4Parton_HT-600To800") || std::string::npos != fname.find("W4JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-600To800") || std::string::npos != fname.find("WJetsToLNu_HT-600To800_13TeV-madgraphMLM-pythia8_4Parton"))
						
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W4Jw->GetSumOfWeights())/float(1.221*485.6*WJNorm) + float(WHTew->GetSumOfWeights())/float(1.221*12.05*WJNorm));



					if (std::string::npos != fname.find("WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_4Parton_HT-800To1200") || std::string::npos != fname.find("W4JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8_HT-800To1200") || std::string::npos != fname.find("WJetsToLNu_HT-800To1200_13TeV-madgraphMLM-pythia8_4Parton"))
						
						normm = Lumi/ ( float(WInclw->GetSumOfWeights())/float(61526.7*WJNorm) + float(W4Jw->GetSumOfWeights())/float(1.221*485.6*WJNorm) + float(WHTfw->GetSumOfWeights())/float(1.221*5.501*WJNorm));
				...
				if (key2) {
					...
					cout<<"  "<<fname<<endl;
						...
						if (!flagg)
						{
			if (std::string::npos != title_.find("JetsToLNu") && std::string::npos == title_.find("TTWJetsToLNu"))  { col=mycolorwjet ; hwj->Add(h2); hwj->SetLineColor(col);}
...
*/
	...
	//				cout<< " was  like ======= "<<signal_names[ij].c_str()<<" will be "<<str<<endl;
...
CheckHistZero (TH1D* &h)
{
			...
			{
				float bc_ = h->GetBinContent(nb);
		//cout<<" ======================================== NB with small entries  iBin "<<nb<<"  error "<<h->GetBinError(nb)<<" BinCont "<<h->GetBinContent(nb)<<"  "<<h->GetName()<<"  "<<h->GetEntries()<<endl;
