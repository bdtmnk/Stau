...
void PlotSamplesRatio(TString histName = "MupT_1",
  ...
  TFile * file = new TFile("SingleMuon_InvTauIso.root");
  ...
  TString samples[16] = {"VVTo2L2Nu", // (0)
		...
		//	 "WZTo2L2Q", // (5) 
			 ...
			 "ZZTo2Q2Nu", // (7)
			 "WJetsToLNu_MG", // (8)
			 "ST_t-channel_4f_leptonDecays_ext1", // (9)
			 "ST_t-channel_4f_leptonDecays_ext1", // (10)
			 "ST_tW_antitop_5f_inclusiveDecays", // (11)
			 "ST_tW_top_5f_inclusiveDecays", // (12)
			 "TTPowHeg", // (13)
			 "DYJetsToLL_M-5to50", // (14)
			 "DYJetsToLL_M-50_MG"}; // (15)
  ...
  TH1F * histDataOld = (TH1F*)file->Get("mutau/"+histName);
