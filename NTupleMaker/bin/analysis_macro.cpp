   ...
   for (int iCand=0; iCand<numberOfCandidates; iCand++) {
	...
	if (applyGoodRunSelection) {
     ...
     if (isN23leading) {
       ...
       ptMuN23H->Fill(LeadingMuon4.Pt(),weight);
       ptTrkN23H->Fill(Track4.Pt(),weight);
       etaMuN23H->Fill(LeadingMuon4.Eta(),weight);
       etaTrkN23H->Fill(Track4.Eta(),weight);
       dRMuTrkN23H->Fill(deltaRMuTrk,weight);
     }      
     if (isN23trailing) {
       ...
       InvMassN23H->Fill(mass,weight);
       ptMuN23H->Fill(TrailingMuon4.Pt(),weight);
       ptTrkN23H->Fill(Track4.Pt(),weight);
       etaMuN23H->Fill(TrailingMuon4.Eta(),weight);
       etaTrkN23H->Fill(Track4.Eta(),weight);
       dRMuTrkN23H->Fill(deltaRMuTrk,weight);
     }      
